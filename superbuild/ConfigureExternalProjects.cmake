...
if(EP_CHECKBOX_CUSTOM_DIRS)
  message(STATUS "EP_CHECKBOX_CUSTOM_DIRS OK")
  ...
  message(STATUS "EP_CHECKBOX_CUSTOM_DIRS NOK")
  if(EP_CHECKBOX_ON_TOP_LEVEL)
    message(STATUS "EP_CHECKBOX_ON_TOP_LEVEL OK")
    if(EP_CHECKBOX_ON_TOP_LEVEL_change)
      message(STATUS "EP_CHECKBOX_ON_TOP_LEVEL CHANGE")
      unset(EP_DIR_NAME CACHE)
    ...
    if(EP_PATH_BASE_change OR EP_CHECKBOX_SIDE_BY_SIDE_change)
      message(STATUS "setOnTop ${EP_PATH_BASE}")
      setOnTop()
    endif()
    message(STATUS "after block ${EP_PATH_BASE}")
  else()
    if(EP_CHECKBOX_ON_TOP_LEVEL_change)
      unset(EP_PATH_BASE CACHE)
...
message(STATUS "EP_PATH_BASE is FINALLY set to: ${EP_PATH_BASE}")
