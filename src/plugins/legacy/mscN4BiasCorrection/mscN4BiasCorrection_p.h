...
class mscN4BiasCorrection;

class mscN4BiasCorrectionPrivate : public dtkAbstractProcess
{
public:
    mscN4BiasCorrectionPrivate() {}

    virtual ~mscN4BiasCorrectionPrivate(void) {}
    ...
    template <class PixelType> int update ( void )
    {
        ...
        */
        if( maskImage)
        {
            qDebug()<<"### Use of a mask for N4 correction.";
       ...
       */
        ...
        */
        ...
        {
            qDebug() << "Exception caught: " << err.GetDescription();
            return medAbstractJob::MED_JOB_EXIT_FAILURE;;
        }
        catch( ... )
        {
